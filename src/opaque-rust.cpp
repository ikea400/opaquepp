...
extern "C" {
::rust::repr::PtrLen cxxbridge1$194$opaque_start_client_registration(::OpaqueStartClientRegistrationParams *params, ::OpaqueStartClientRegistrationResult *return$) noexcept;

::rust::repr::PtrLen cxxbridge1$194$opaque_finish_client_registration(::OpaqueFinishClientRegistrationParams *params, ::OpaqueFinishClientRegistrationResult *return$) noexcept;
...
::rust::repr::PtrLen cxxbridge1$194$opaque_finish_server_login(::OpaqueFinishServerLoginParams *params, ::OpaqueFinishServerLoginResult *return$) noexcept;
} // extern "C"
...
::OpaqueStartClientRegistrationResult opaque_start_client_registration(::OpaqueStartClientRegistrationParams params) {
  ...
  ::rust::repr::PtrLen error$ = cxxbridge1$194$opaque_start_client_registration(&params$.value, &return$.value);
  if (error$.ptr) {
...
::OpaqueFinishClientRegistrationResult opaque_finish_client_registration(::OpaqueFinishClientRegistrationParams params) {
  ...
  ::rust::repr::PtrLen error$ = cxxbridge1$194$opaque_finish_client_registration(&params$.value, &return$.value);
  if (error$.ptr) {
    throw ::rust::impl<::rust::Error>::error(error$);
  }
  return ::std::move(return$.value);
...
::OpaqueStartClientLoginResult opaque_start_client_login(::OpaqueStartClientLoginParams params) {
  ...
  ::rust::repr::PtrLen error$ = cxxbridge1$194$opaque_start_client_login(&params$.value, &return$.value);
  if (error$.ptr) {
    throw ::rust::impl<::rust::Error>::error(error$);
  }
  return ::std::move(return$.value);
...
::rust::Vec<::std::uint8_t> opaque_create_server_setup() noexcept {
  ...
  cxxbridge1$194$opaque_create_server_setup(&return$.value);
  return ::std::move(return$.value);
}

::rust::Vec<::std::uint8_t> opaque_get_server_public_key(::rust::Slice<::std::uint8_t const> data) {
  ::rust::MaybeUninit<::rust::Vec<::std::uint8_t>> return$;
  ::rust::repr::PtrLen error$ = cxxbridge1$194$opaque_get_server_public_key(data, &return$.value);
  if (error$.ptr) {
    throw ::rust::impl<::rust::Error>::error(error$);
  }
  return ::std::move(return$.value);
...
::OpaqueStartServerLoginResult opaque_start_server_login(::OpaqueStartServerLoginParams params) {
  ...
  ::rust::repr::PtrLen error$ = cxxbridge1$194$opaque_start_server_login(&params$.value, &return$.value);
  if (error$.ptr) {
    throw ::rust::impl<::rust::Error>::error(error$);
  }
  return ::std::move(return$.value);
...
::OpaqueFinishServerLoginResult opaque_finish_server_login(::OpaqueFinishServerLoginParams params) {
  ...
  ::rust::repr::PtrLen error$ = cxxbridge1$194$opaque_finish_server_login(&params$.value, &return$.value);
  if (error$.ptr) {
    throw ::rust::impl<::rust::Error>::error(error$);
  }
  return ::std::move(return$.value);
